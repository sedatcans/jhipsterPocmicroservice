package com.sedatcan.jhipsterpocmicroservice.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jhipsterPocmicroservice");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jhipsterPocmicroservice");
        ...
        config.getMapConfigs().put("com.sedatcan.jhipsterpocmicroservice.domain.*", initializeDomainMapConfig(jHipsterProperties));
